...
- **Keep colors you dislike out**: paste hex values as avoided colors, or right-click a color in the palette. Generated colors keep away from them, half again the distance they keep from each other.
