...
- **See where the colors landed**: a hue/saturation plot with a dot for each generated color. Both axes are perceptual - equal distances cover equal perceived change, not equal HSL units.
