...
//
//     node data/hue-marginals.js [--seeds 200] [--box lMin lMax cMin cMax] [--names] [page.html] [metric/draw ...]
//
...
function main(args) {
	let seeds = 200, box = { lMin: 20, lMax: 60, cMin: 20, cMax: 100 }, names = false, pagePath = null;
	const conditions = [];
	...
	console.log(path.basename(pagePath) + ", box L " + box.lMin + "-" + box.lMax + ", C " + box.cMin + "-" + box.cMax + "%, " + seeds + " seeds at " + COUNTS.join(" and ") + " colors");
